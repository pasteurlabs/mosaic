...
def generate(out_dir: Path) -> None:
    ...
    if not npz_path.exists():
        print(f"[thermal_source_recovery] {npz_path} not found — run: "
    ...
    with plt.rc_context(RCPARAMS):
        ...
        im_gt = _imshow(ax_gt, Q_gt, "inferno", 0, vmax_Q,
                        title="GT source $Q$", ylabel="Ground truth")
        ...
        for row_i, solver in enumerate(solvers, start=1):
            ...
            _imshow(ax_rec, Q_rec, "inferno", 0, vmax_Q,
