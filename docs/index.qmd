...
→ Head over to **[Getting Started](getting-started.qmd)** for installation, the smoke-test workflow, and the full CLI reference. To call a Mosaic solver from your own code without the harness, see **[Standalone Usage](standalone.qmd)**.
